    ...
    fun offline(tilesUrl: String = "http://localhost:8787/tiles/{z}/{x}/{y}.pbf"): String = """
    {
      ...
      "layers": [
        ...
        { "id": "landuse-green", "type": "fill", "source": "sb", "source-layer": "land",
          "filter": ["in", ["get", "kind"], ["literal", ["park","garden","meadow","grass","village_green","recreation_ground","golf_course"]]],
        ...
        { "id": "landuse-savanna", "type": "fill", "source": "sb", "source-layer": "land",
          "filter": ["in", ["get", "kind"], ["literal", ["scrub","grassland","heath"]]],
          "paint": { "fill-color": "#dcd2a0", "fill-opacity": 0.5 } },
        { "id": "landuse-arid", "type": "fill", "source": "sb", "source-layer": "land",
          "filter": ["in", ["get", "kind"], ["literal", ["sand","beach","bare_rock","scree","shingle"]]],
          "paint": { "fill-color": "#ecdfc0", "fill-opacity": 0.6 } },
        { "id": "landuse-wetland", "type": "fill", "source": "sb", "source-layer": "land",
          "filter": ["in", ["get", "kind"], ["literal", ["swamp","bog","string_bog","wet_meadow","marsh"]]],
          "paint": { "fill-color": "#b8d4c0", "fill-opacity": 0.5 } },
        ...
        { "id": "pois-amenity", "type": "symbol", "source": "sb", "source-layer": "pois",
          ...
          "filter": ["in", ["get","amenity"], ["literal", [
              "pharmacy", "hospital", "clinic", "doctors", "veterinary",
              "restaurant", "fast_food", "cafe", "bar", "atm", "parking",
              "police", "kindergarten", "place_of_worship", "ice_cream",
              "drinking_water", "grave_yard", "fountain",
              "toilets", "pub", "food_court"
          ]]],
          "layout": {
            "icon-image": ["match", ["get","amenity"],
              "pharmacy", "pharmacy", "hospital", "hospital",
              "clinic", "doctors", "doctors", "doctors",
              "veterinary", "veterinary", "restaurant", "restaurant",
              "fast_food", "fast_food", "cafe", "cafe", "bar", "bar",
              "atm", "bank", "parking", "parking",
              "police", "police",
              "kindergarten", "school",
              "place_of_worship", "place_of_worship", "ice_cream", "ice_cream",
              "drinking_water", "drinking_water", "grave_yard", "cemetery",
              "fountain", "drinking_water",
              "toilets", "toilets", "pub", "beer",
              "circle"],
            "icon-size": ["interpolate",["linear"],["zoom"],14,1.2,16,1.8,18,2.5],
        ...
        { "id": "pois-shop", "type": "symbol", "source": "sb", "source-layer": "pois",
          "minzoom": 14,
          "filter": ["in", ["get","shop"], ["literal", [
              "supermarket", "bakery", "alcohol", "beverages"
          ]]],
          "layout": {
        ...
        { "id": "pois-tourism", "type": "symbol", "source": "sb", "source-layer": "pois",
          "minzoom": 14,
          "filter": ["any",
              ["in", ["get","tourism"], ["literal", [
                  "hotel", "motel", "hostel", "guest_house", "camp_site", "museum", "viewpoint",
                  "picnic_site", "alpine_hut", "caravan_site", "bed_and_breakfast"
              ]]],
              ["all", ["==", ["get","tourism"], "information"], ["==", ["get","information"], "office"]]
          ],
          "layout": {
            "icon-image": ["match", ["get","tourism"],
              "hotel", "lodging", "motel", "lodging", "hostel", "lodging",
              "guest_house", "lodging", "bed_and_breakfast", "lodging", "alpine_hut", "lodging",
              "camp_site", "campsite", "caravan_site", "campsite",
              "picnic_site", "picnic_site",
              "museum", "museum", "viewpoint", "monument",
        ...
        { "id": "pois-leisure", "type": "symbol", "source": "sb", "source-layer": "pois",
          "minzoom": 14,
          "filter": ["in", ["get","leisure"], ["literal", ["playground", "sports_centre", "pitch"]]],
          "layout": {
            "icon-image": ["match", ["get","leisure"],
              "playground", "playground",
              "sports_centre", "stadium", "pitch", "stadium",
              "circle"],
            "icon-size": ["interpolate",["linear"],["zoom"],14,1.2,16,1.8,18,2.5],
            "icon-allow-overlap": false,
            "text-field": ["step",["zoom"],"",16,["get","name"]],
          ...
          "paint": { "icon-opacity": 0.9, "text-color": "#555555", "text-halo-color": "#ffffff", "text-halo-width": 1 } },
        { "id": "pois-emergency", "type": "symbol", "source": "sb", "source-layer": "pois",
          "minzoom": 14,
          "filter": ["==", ["get","emergency"], "defibrillator"],
          "layout": {
            "icon-image": "heart",
            "icon-size": ["interpolate",["linear"],["zoom"],14,1.2,16,1.8,18,2.5],
            "icon-allow-overlap": false,
